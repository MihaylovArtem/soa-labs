...
public class HelloResponse {
    ...
    @XmlElementRef(name = "helloResult", namespace = "ru.susu.time", type = JAXBElement.class, required = false)
    protected JAXBElement<String> helloResult;
     ...
     *     
     */
    public JAXBElement<String> getHelloResult() {
        return helloResult;
    }
     ...
     *     
     */
    public void setHelloResult(JAXBElement<String> value) {
